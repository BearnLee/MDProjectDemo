...
public class DividerItemGridLayout extends RecyclerView.ItemDecoration {

    Paint mVerPaint, mHorPaint;
    Builder mBuilder;

    public DividerItemGridLayout(Builder builder) {
        init(builder);
    }
    ...
    public static class Builder {
        ...
        public DividerItemGridLayout build() {
            return new DividerItemGridLayout(this);
        }
    }
}
